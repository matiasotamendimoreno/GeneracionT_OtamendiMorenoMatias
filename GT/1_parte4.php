...
<div class="container mt-5">
    <div class="col-md-6 mb-4">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">La Muerte de Superman - Batman v Superman</h5>
                <div class="ratio ratio-16x9">
                    <iframe src="https://www.youtube.com/embed/_BdniQAlM5E" title="YouTube video" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
